...
document.addEventListener("DOMContentLoaded", () => {
    const form = document.getElementById("gameboard-form");
    const gridContainer = document.getElementById("grid");
    const colorPicker = document.getElementById("colorPicker");
    const generateButton = document.getElementById("generateGridButton");
    const dotsDataField = document.querySelector("input[name='dots_data']");
