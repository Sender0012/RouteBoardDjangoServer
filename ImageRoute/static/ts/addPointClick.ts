...
//   canvas.height = img.height;
  ...
  const inputX = document.querySelector("input[name='x']") as HTMLInputElement;
  const inputY = document.querySelector("input[name='y']") as HTMLInputElement;
